...
<body>
	<!-- <nav class="navbar text-light navbar-expand-sm mb-5 fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myTogglerNav">
				<div class="navbar-nav ml-auto">
					<a class="nav-item nav-link" href="#experience">About Me</a>
			...
			<div id="experience" class="container pt-2">
				<div class="row mb-4">
					...
					<section class="col-md-9 text-left">					
						...
						<span class="expand-icon"><img src="images/down1.png" width="30"></span>
						<span class="contract-icon"><img src="images/up1.png" width="30"></span>
